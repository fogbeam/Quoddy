<html>
		...
		<title>Welcome to Quoddy</title>
       	...
       	<script type="text/javascript" language="javascript">
			$j( function() 
			{
				...
				// var bcDiv = document.getElementById("enrichedContent");
				// var enhanceJSON = bcDiv.getAttribute("data-var");
				// alert( enhanceJSON );
				
				//alert(bcDiv.getAttribute("data-var"));

				// turn the JSON string into an actual Javascript object
				// var obj = $j.parseJSON( enhanceJSON );
	...
	<body>
		...
		<div id="enrichedContent" style="margin-top:18px;">
			${content}
		</div>
	</body>
</html>