<div class="hero-unit">
	<g:if test="${session.user}">
		...
		<img style="float: left;"
			src="${createLink(controller:'profilePic',action:'thumbnail',id:session.user.userId)}" />
		<h3>
...
<div class="hero-unit">
	<g:if test="${session.user}">
		<h3>Streams</h3>
		<g:link controller="userStream" action="index"
			class="btn manageStreams">
			<i class="icon-cog"></i>
		</g:link>
	...
	<g:if test="${session.user}">
		<h3>Lists</h3>
		<g:link controller="userList" action="index" class="btn manageStreams">
			<i class="icon-cog"></i>
		</g:link>
		<ul>
	...
	<g:if test="${session.user}">
		<h3>Groups</h3>
		<g:link controller="userGroup" action="index"
			class="manageStreams btn">
			<i class="icon-cog"></i>
		</g:link>
		<ul>
	...
	<g:if test="${session.user}">
		<h3>Subscriptions</h3>
		<g:link controller="eventSubscription" action="index"
			class="btn manageStreams">
			<i class="icon-cog"></i>
		</g:link>
